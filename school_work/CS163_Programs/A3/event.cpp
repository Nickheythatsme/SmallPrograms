...
//CS163
//Filename: "event.cpp"
//This is the implementation of the event struct. The constructor/destructor
//are here, as well as all the event_s functions.
#include "table.h"
...
int event_s::copy( event_s & to_copy )
{
    if( name )
        delete [] name;
    if( location )
...
int event_s::display()
{
    //The 'time' variable in event_s holds our event's time in seconds since
